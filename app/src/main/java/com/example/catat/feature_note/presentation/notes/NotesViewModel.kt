...
import com.example.catat.feature_note.domain.use_case.NoteUseCases
import com.example.catat.feature_note.domain.util.NoteOrder
import com.example.catat.feature_note.domain.util.OrderType
...
class NotesViewModel @Inject constructor(
    ...
    fun saveNote(noteId: String, noteContent: String) {
        viewModelScope.launch {
            preferencesManager.saveNote(noteId, noteContent)
        }
    }

    fun getNoteContent(noteId: String): String? {
        return preferencesManager.getNoteContent(noteId)
    }

    fun deleteNoteContent(noteId: String) {
        viewModelScope.launch {
            preferencesManager.deleteNoteContent(noteId)
        }
    }
